...
comment on column XXL_JOB_REGISTRY.UPDATE_TIME
 is '修改时间';
create index IDXXXLJOBREGISTRYREGISTRYGROUP on XXL_JOB_REGISTRY(REGISTRY_GROUP) ;
create index IDXXXLJOB_REGISTRY_UPDATE_TIME on XXL_JOB_REGISTRY(UPDATE_TIME) ;
